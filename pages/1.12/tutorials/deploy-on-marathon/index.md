...
Jenkins for DC/OS can be accessed through the Dashboard or Services navigation menu’s within the [DC/OS web interface](/1.12/gui/).

Click the “Jenkins” service and then "Open Service" to access the Jenkins web interface.

![dcos-velocity-jenkins-ui.png](/1.12/img/dcos-velocity-jenkins-ui.png)
...
![dcos-velocity-jenkins-creds-new.png](/1.12/img/dcos-velocity-jenkins-creds-new.png)
...
![dcos-jenkins-new-freestyle.png](/1.12/img/dcos-jenkins-new-freestyle.png)
