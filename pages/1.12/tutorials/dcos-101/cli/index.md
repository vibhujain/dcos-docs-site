...
# Steps
  * Install the DC/OS CLI
    * Follow the steps [here](/1.12/cli/install/) or the `Install CLI` instruction in the lower left corner of the DC/OS GUI.
    ...
    * You can also add/invite friends and co-workers to your cluster. See [user management documentation](/1.12/security/ent/users-groups/) for details
...
* [Universe](/1.12/overview/architecture/components/#dcos-package-manager) is the package repository that holds the DC/OS services (e.g. Apache Spark or Apache Cassandra) that you can install on your cluster directly from the DC/OS GUI and CLI.
