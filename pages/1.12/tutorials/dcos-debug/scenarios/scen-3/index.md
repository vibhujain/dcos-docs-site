...
As we learned [earlier](/1.12/tutorials/dcos-debug/gen-strat/), with application failures the [first step](/1.12/tutorials/dcos-debug/gen-strat/#task-strat) is to check the [task logs](/1.12/tutorials/dcos-debug/tools/#task-logs).
...
However, this does not shed much light on why the task failed. So then to [Step 3](/1.12/tutorials/dcos-debug/gen-strat/#agent-strat) of our [strategy](/1.12/tutorials/dcos-debug/gen-strat/): check the [Mesos agent logs](/1.12/tutorials/dcos-debug/tools/#agent-logs) using:
