...
*  [DC/OS](/1.12/installing/) or [DC/OS Enterprise](/1.12/installing/) installed with at least 5 [private agents][6] and 1 [public agent][6].
*  [DC/OS CLI](/1.12/cli/install/) installed.
...
In this step you install Cassandra, Kafka, Marathon-LB, and Zeppelin from the DC/OS web interface [**Catalog**](/1.12/gui/catalog/) tab. You can also install DC/OS packages from the DC/OS CLI with the [`dcos package install`][11] command.
...
If you are having trouble getting Marathon-LB up and running on an Enterprise cluster, try installing it following [these instructions](/services/marathon-lb/mlb-auth/). Depending on your [security mode](/1.12/security/ent/#security-modes), Marathon-LB may require service authentication for access to DC/OS.
